...
RECIPES.push({
  ...
  ingredients: [
    ...
    { item: 'Diamond Crystal kosher salt, for the brine', grams: '2.1 g', practical: '¾ tsp' },
  ...
  steps: [
    ...
    { title: 'Dimple and brine', body: 'Stir the 45 g water and 2.1 g kosher salt together until dissolved. Drizzle the 27 g olive oil over the dough, then press straight down to the pan bottom with oiled fingertips, all over, about an inch apart. Spoon the brine into the dimples, scatter the 2 g rosemary and a pinch of flaky salt.', checkpoint: 'Dimples hold and do not spring back, and the surface is pooled and glossy — the brine should look like too much liquid.', why: 'The brine seasons the crust and steams off in the oven, keeping the top tender and dappled instead of drying into a hard shell.' },
  ...
  notes: [
    'Traditional salamoia emulsifies the oil into the brine instead of drizzling it on separately: whisk the 27 g finishing oil into the salt water and spoon the emulsion into the dimples. That is the Genoese method and it distributes more evenly \u2014 the brine is the reason the dimples stay open, since liquid sitting in them cannot climb past the boil while it steams off.',
