...
RECIPES.push({
  ...
  category: 'Bread',
  subcat: 'Loafs',
  description: 'Crusty baguette-style bread. Dough cycle in the bread maker, hand-shaped, scored and baked with steam for a crackly crust — same day, or with an overnight cold rest for more flavor.',
  yield: '2 baguettes',
  ...
  steps: [
    ...
    { title: 'Bulk rest — same day or overnight', body: 'The dough cycle has already given the dough its first rise, so the choice happens here, before shaping. Pick a path.\n\n• Same day: go straight on to dividing and shaping.\n• Overnight (better flavor, better crust): scrape the dough into a lightly oiled container, cover tightly, and refrigerate 8–24 hours. The next day take it out and let it stand covered at room temperature 1–2 hours before dividing. Everything after runs as written, but let the second rise go 45–75 minutes instead of 30–45 since the dough starts cool.', checkpoint: 'Ready to shape when the dough is puffy and slack rather than tight, and a floured fingertip leaves a dent that fills in slowly. A refrigerated dough that still feels dense and cold in the middle needs more counter time — no amount of clock-watching substitutes.', why: 'There is nothing in this dough but flour, water, yeast and a little butter, so flavor has to come from time. The overnight version tastes distinctly more like bread and browns deeper. Same day is the right call when the baguettes are for tonight, and it is still a good loaf.' },
